...
<div class="flex-grow-1 p-4 p-lg-5 w-100" style="background:#F9FAFB;min-height:100vh;">
    ...
    <div class="mb-4">
        <h2 class="fw-bold mb-0" style="color:#111827;">Platoons</h2>
        <p class="text-muted" style="font-size:0.88rem;">Manage ROTC platoons and section rosters</p>
    </div>
    <div class="d-flex flex-column align-items-center justify-content-center py-5 text-center"
        ...
        <h6 style="color:#374151;font-weight:600;margin-bottom:4px;">Platoons Module</h6>
        <p class="text-muted small">This page is coming soon. Platoon management will appear here.</p>
    </div>
</div>
