...
$extra_css = ['../assets/css/pages/instructor/dashboard.css'];
...
<div class="flex-grow-1 p-5">
    ...
    <div class="row g-4 mb-4">
        <div class="col-md-3"><div class="stat-card"><div><small class="text-muted d-block">My Students</small><h2 class="fw-bold mb-0"><?= $student_count ?></h2></div><div class="icon-box bg-blue-brand"><i class="bi bi-people"></i></div></div></div>
        <div class="col-md-3"><div class="stat-card"><div><small class="text-muted d-block">Attendance Rate</small><h2 class="fw-bold mb-0"><?= $attendance_rate ?>%</h2></div><div class="icon-box bg-green-brand"><i class="bi bi-check2-square"></i></div></div></div>
        <div class="col-md-3"><div class="stat-card"><div><small class="text-muted d-block">Activity Plans</small><h2 class="fw-bold mb-0"><?= count($activity_plans) ?></h2></div><div class="icon-box bg-purple-brand"><i class="bi bi-file-earmark-text"></i></div></div></div>
        <div class="col-md-3"><div class="stat-card"><div><small class="text-muted d-block">Reports Submitted</small><h2 class="fw-bold mb-0"><?= count($accomplishment_reports) ?></h2></div><div class="icon-box bg-orange-brand"><i class="bi bi-calendar-event"></i></div></div></div>
    </div>

    <div class="panel-container">
        <h5 class="fw-bold mb-4">My Section Details</h5>
        <div class="row">
            <div class="col-md-3"><div class="d-flex align-items-center"><i class="bi bi-people text-primary me-2 fs-5"></i><div><small class="text-muted d-block">Section</small><strong><?= $section ? htmlspecialchars($section['section_name']) : 'Not Assigned' ?></strong></div></div></div>
            <div class="col-md-3"><div class="d-flex align-items-center"><i class="bi bi-check-circle text-success me-2 fs-5"></i><div><small class="text-muted d-block">Students</small><strong><?= $student_count ?> (<?= $active_student_count ?> active)</strong></div></div></div>
            <div class="col-md-3"><div class="d-flex align-items-center"><i class="bi bi-geo-alt me-2 fs-5"></i><div><small class="text-muted d-block">Room Assignment</small><strong>Room 301</strong></div></div></div>
            <div class="col-md-3"><div class="d-flex align-items-center"><i class="bi bi-clock me-2 fs-5"></i><div><small class="text-muted d-block">Schedule</small><strong>Thursdays, 8:00 AM - 10:00 AM</strong></div></div></div>
        </div>
    </div>
    ...
    <div class="row g-4 mb-4">
        <div class="col-md-6">
            <div class="panel-container">
                <div class="d-flex justify-content-between mb-3"><h5 class="fw-bold mb-0">Activity Plans</h5><a href="#" class="text-primary text-decoration-none small">View All</a></div>
        ...
        <div class="col-md-6">
            <div class="panel-container">
                <div class="d-flex justify-content-between mb-3"><h5 class="fw-bold mb-0">Accomplishment Reports</h5><a href="#" class="text-primary text-decoration-none small">View All</a></div>
                <div class="list-group list-group-flush">
    ...
    <div class="panel-container" style="background-color: #F0F7FF; border: 1px solid #CFE2FF;">
        <div class="d-flex align-items-center mb-3"><i class="bi bi-info-circle text-primary me-2"></i><h6 class="fw-bold mb-0 text-primary">Quick Actions</h6></div>
        <div class="d-flex">
